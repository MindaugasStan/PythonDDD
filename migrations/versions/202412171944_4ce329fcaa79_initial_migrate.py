...
Revision ID: 4ce329fcaa79
Revises: 
Create Date: 2024-12-17 19:44:11.326048+00:00
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("jobenddate", sa.DateTime(timezone=True), nullable=True),
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f("fk_employees_senioritylevel_id_seniority_levels"),
            ondelete="CASCADE",
        ),
